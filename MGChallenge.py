...
userInputforDorE = input("Are you decoding a file/text or encoding text? (d = decode, e = encode)\n")
...
if sepperator == "":
    sepperator = "|+|-"
if userInputforDorE.casefold() == "e":
...
elif userInputforDorE.casefold() == "d":
